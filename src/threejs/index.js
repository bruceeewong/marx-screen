...
function init(stage) {
  ...
  // container.style.cssText += ';position:absolute;height:0;padding-top:100%;width:100%'
  ...
  const texturePlante = THREE.ImageUtils.loadTexture('./models/mars_surface.jpg', null, () => {});// 模型贴图

  const fbxLoader = new FBXLoader();

  // fbx静态模型
  fbxLoader.load('./models/mars.fbx', (object) => {
